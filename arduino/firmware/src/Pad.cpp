...
void Pad::exploreService(BLEService service) {
...
void Pad::exploreCharacteristic(BLECharacteristic characteristic) {
...
void Pad::exploreDescriptor(BLEDescriptor descriptor) {
...
void Pad::printData(const unsigned char data[], int length) {
